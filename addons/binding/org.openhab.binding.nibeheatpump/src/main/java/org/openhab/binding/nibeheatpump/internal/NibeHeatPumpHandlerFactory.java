...
/**
 * The {@link NibeHeatPumpHandlerFactory} is responsible for creating things and thing 
 * handlers.
 * 
...
public class NibeHeatPumpHandlerFactory extends BaseThingHandlerFactory {
    ...
    private final static Set<ThingTypeUID> SUPPORTED_THING_TYPES_UIDS = Collections.singleton(THING_TYPE_F1245);
    ...
    protected ThingHandler createHandler(Thing thing) {
        ...
        if (thingTypeUID.equals(THING_TYPE_F1245)) {
